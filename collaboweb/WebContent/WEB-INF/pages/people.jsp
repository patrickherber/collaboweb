...
<html>
<head>
	<title><bean:message key="application.title" /> &gt; <bean:message key="people.pageTitle" /></title>
...
<h1><bean:message key="people.pageTitle"/></h1>
...
<jsp:include flush="true" page="include/messages.jsp"/>
	...
	<table width="100%">
		<tr valign="top">
			<td width="70%">
				<c:if test="${ resource.parentId != 0 && resource.resourceId != userInfo.community.peopleRootId}">
