...
<html>
<head>
	<title><bean:message key="application.title" /> &gt; <bean:message key="validationType.pageTitle" /></title>
...
<body>
	...
	<h2><bean:message key="validationType.pageTitle"/></h2>
		
	<jsp:include flush="true" page="include/messages.jsp"/>

	<html:form action="/validation-type.html" focus="className">
		<table width="750" class="form">
			<tr>
				<td class="label"><bean:message key="validationType.className"/></td>
				<td><html:text property="className" style="width: 500px;"/></td>
			</tr>
			<tr>
				<td class="label"><bean:message key="validationType.description"/></td>
				<td>
			...
			<tr>
				<td class="label"><bean:message key="validationType.message"/></td>
				<td>
			...
			<tr>
				...
				<td>
					...
					<input type="button" class="button" value="<bean:message key="application.back"/>" onclick="location.href='<c:url value="validation-types.html"/>';"/>
				</td>
			</tr>
		</table>
	</html:form>
