...
/**
 * Struts action used to get a list of action objects.
 *
 * @author <a href="mailto:patrick@arpage.ch">Patrick Herber</a>
 */
public class ActionsAction extends AbstractSecureAction {
	...
	protected ActionForward executeAction(ActionMapping mapping, ActionForm form, 
		...
		try {
			request.setAttribute("list", resourceTypeManager.getActions(user));
		} catch (Exception e) {
