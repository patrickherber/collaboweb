...
/**
 * Struts action used to delete a resource type.
 *
 * @author <a href="mailto:patrick@arpage.ch">Patrick Herber</a>
 */
public class ResourceTypeDeleteAction extends AbstractSecureAction {
	...
	protected ActionForward executeAction(ActionMapping mapping, ActionForm form, 
		...
		if (typeId != 0) {
			try {
				resourceTypeManager.delete(typeId, user);
				addSessionMessage(request, "message.resourceType.deleted");
