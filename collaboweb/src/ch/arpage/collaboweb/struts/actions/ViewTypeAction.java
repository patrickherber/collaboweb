...
import ch.arpage.collaboweb.struts.forms.ViewTypeForm;

/**
 * Struts action used to save a view type object.
 *
 * @author <a href="mailto:patrick@arpage.ch">Patrick Herber</a>
 */
public class ViewTypeAction extends AbstractSecureAction {
	...
	protected ActionForward executeAction(ActionMapping mapping, ActionForm form, 
		...
		ViewTypeForm viewTypeForm = (ViewTypeForm) form;
		
		try {
			if (viewTypeForm.isSubmitted()) {
				resourceTypeManager.saveViewType(viewTypeForm.getViewType(), 
						user);
