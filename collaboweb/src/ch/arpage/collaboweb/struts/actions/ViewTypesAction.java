...
/**
 * Struts action used to get a list of view types objects.
 *
 * @author <a href="mailto:patrick@arpage.ch">Patrick Herber</a>
 */
public class ViewTypesAction extends AbstractSecureAction {
	...
	protected ActionForward executeAction(ActionMapping mapping, ActionForm form, 
		...
		try {
			request.setAttribute("list", resourceTypeManager.getViewTypes(user));
		} catch (Exception e) {
