...
// ---- Common Options ----
var gMonths=["Gen","Feb","Mar","Apr","Mag","Gun","Lug","Ago","Set","Ott","Nov","Dic"];
var gWeekDay=["Do","Lu","Ma","Me","Gi","Ve","Sa"];	// weekday caption from Sunday to Saturday
...
var gcCalBG="#BACAFF";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#324BA6";	// the background color of the inner table, showing as a frame.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Oggi: "+gToday[2]+" "+gMonths[gToday[1]-1]+" "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcSatBG="#DCE4FF";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#DCE4FF";	// Sunday background color

var gcOtherDay="#eeeeee";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
