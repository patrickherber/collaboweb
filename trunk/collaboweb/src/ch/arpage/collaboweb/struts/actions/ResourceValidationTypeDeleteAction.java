...
/**
 * Struts action used to delete a resource validation type object.
 *
 * @author <a href="mailto:patrick@arpage.ch">Patrick Herber</a>
 */
public class ResourceValidationTypeDeleteAction extends AbstractSecureAction {
	...
	protected ActionForward executeAction(ActionMapping mapping, ActionForm form, 
		...
		if (validationTypeId != 0) {
			try {
				resourceTypeManager.deleteResourceValidationType(
						validationTypeId, user);
				addSessionMessage(request, 
						"message.resourceValidationType.deleted");
